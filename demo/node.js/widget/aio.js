...
if (typeof define === "function" && define.amd) {
    define('modules/index_height100',[], function() {
...
var index_scroll_down = {
    ...
    init: function(opt) {
        ...
        $(window).scroll(function(){
            if ($(window).scrollTop()>big_box_obj.height()&&!big_box_obj.hasClass("not")) {
                $(window).scrollTop($(window).scrollTop()-big_box_obj.height());
                big_box_obj.hide();
                big_box_obj.addClass("not");
            }
        });
...
if (typeof define === "function" && define.amd) {
    define('modules/index_scroll_down',["lib/jquery.min"], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/nav_still_top',["lib/jquery.min"], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/leav_message_window',["lib/jquery.min"], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/qq_message_window',["lib/jquery.min"], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/background_change',[], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/index_banner_switch',["lib/jquery.min"], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/index_reversal_ninebox',["lib/jquery.min"], function() {
...
define('modules/goto_top',["lib/jquery.min"], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/index_cascade',["lib/jquery.min"], function() {
...
if (typeof define === "function" && define.amd) {
    define('modules/screen_mouseMove',[], function() {
...
define('app/index',['modules/index_height100','modules/index_scroll_down','modules/nav_still_top','modules/leav_message_window','modules/qq_message_window','modules/background_change','modules/index_banner_switch','modules/index_reversal_ninebox','modules/goto_top','modules/mask','modules/index_cascade','modules/screen_mouseMove','lib/GrayScale','lib/jquery.min'], function($index_height100,$index_scroll_down,$nav_still_top,$leav_message_window,$qq_message_window,$background_change,$index_banner_switch,$index_reversal_ninebox,$goto_top,$mask,$index_cascade,$screen_mouseMove,$GrayScale) {
	var index = {
		init : function (){
			//顶部banner100高度
			var opt_100 = {
...
if (typeof define === "function" && define.amd) {
    define('modules/baidu_map',["http://api.map.baidu.com/getscript?v=2.0&ak=cQoqZZ4o1Yy96sEiIlIVkkek"], function() {
        return baidu_map;
    });
}
...
define('app/join_us',["modules/baidu_map", "lib/jquery.min"], function($baidu_map) {
